...
using wateen12148ArticalProject.Code;
using wateen12148ArticalProject.Core;
using wateen12148ArticalProject.Data;
using wateen12148ArticalProject.Data.AqlServerEF;

namespace wateen12148ArticalProject
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //inject table
            services.AddSingleton<IDataHelper<Category>, CategoryEnti>();
